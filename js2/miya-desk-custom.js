(function (global) {
  ...
  function buildWidgetCatalog() {
    ...
    cat.blank_4x2_7 = { w: 4, h: 2, label: '个人名片', widget: 'profile', editable: true };
    cat.blank_4x2_8 = { w: 4, h: 2, label: '滚动歌词', widget: 'scrolllyrics', editable: true };
    cat.blank_4x3_1 = { w: 4, h: 3, label: '照片墙', widget: 'photowall', editable: true };
  ...
  function createProfileWidgetEl() {
    ...
    el.className = 'wg wg-profile wg-profile--flat desk-custom__wg desk-custom__wg--profile';
    el.setAttribute('aria-label', '个人名片');
    el.innerHTML =
  ...
  function buildWidgetPicker() {
    ...
    addSection('4×2', ['blank_4x2_1', 'blank_4x2_2', 'blank_4x2_3', 'blank_4x2_4', 'blank_4x2_5', 'blank_4x2_6', 'blank_4x2_7', 'blank_4x2_8'].concat(customIdsForSize(4, 2)));
