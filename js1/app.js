(function () {
  ...
  var SVG_CLASSIC = {
    ...
    quotes: '<svg viewBox="0 0 24 24" fill="none"><path d="M12 20s-7-4.5-7-10.5A4.5 4.5 0 0 1 12 5a4.5 4.5 0 0 1 7 4.5c0 6-7 10.5-7 10.5z" stroke="rgba(70,74,80,0.82)" stroke-width="1.3" stroke-linejoin="round"/><circle cx="16.5" cy="16.5" r="3.8" fill="#F7F5F2" stroke="rgba(70,74,80,0.82)" stroke-width="1.2"/><path d="M16.5 14.5v4M14.5 16.5h4" stroke="rgba(70,74,80,0.82)" stroke-width="1.3" stroke-linecap="round"/></svg>',
  };
